        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav ms-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link btn-register" href="./pages/register.php">Registrarse</a>
                    </li>
                </ul>
            </div>
        </div>
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 hero-text">
                    ...
                    <div class="hero-buttons">
                        <a href="./pages/register.php" class="btn btn-primary btn-lg">Comenzar ahora</a>
                        <a href="#como-funciona" class="btn btn-outline-light btn-lg ms-3">Cómo funciona</a>
                    </div>
                </div>
                <div class="col-lg-6 hero-image">
                    <img src="/placeholder.svg?height=500&width=600&query=amigos viendo películas juntos, ilustración moderna" alt="Amigos viendo películas" class="img-fluid">
                </div>
            </div>
        </div>
        <div class="hero-wave">
        ...
        <div class="container">
            ...
            <div class="row align-items-center feature-row">
                <div class="col-lg-6 feature-image">
                    <img src="/placeholder.svg?height=400&width=500&query=catálogo de películas en una aplicación móvil, diseño moderno" alt="Catálogo de películas" class="img-fluid rounded-3 shadow">
                </div>
            ...
            <div class="row align-items-center feature-row reverse">
                ...
                <div class="col-lg-6 feature-image">
                    <img src="/placeholder.svg?height=400&width=500&query=algoritmo de coincidencia, visualización de datos, concepto moderno" alt="Algoritmo de coincidencia" class="img-fluid rounded-3 shadow">
                </div>
            </div>
            <div class="row align-items-center feature-row">
                <div class="col-lg-6 feature-image">
                    <img src="/placeholder.svg?height=400&width=500&query=personas celebrando un match de película, diseño moderno" alt="Celebración de match" class="img-fluid rounded-3 shadow">
                </div>
                <div class="col-lg-6 feature-text">
                    <div class="feature-icon">
                        <i class="fas fa-heart"></i>
        ...
        <div class="container">
            ...
            <div class="row testimonials-container">
                <div class="col-md-4">
                    <div class="testimonial-card">
                        <div class="testimonial-avatar">
                            <img src="/placeholder.svg?height=80&width=80&query=avatar mujer joven sonriente" alt="Usuario" class="img-fluid rounded-circle">
                        </div>
                ...
                <div class="col-md-4">
                    <div class="testimonial-card">
                        <div class="testimonial-avatar">
                            <img src="/placeholder.svg?height=80&width=80&query=avatar hombre joven sonriente" alt="Usuario" class="img-fluid rounded-circle">
                        </div>
                        <div class="testimonial-content">
                ...
                <div class="col-md-4">
                    <div class="testimonial-card">
                        <div class="testimonial-avatar">
                            <img src="/placeholder.svg?height=80&width=80&query=avatar mujer joven con gafas" alt="Usuario" class="img-fluid rounded-circle">
                        </div>
                        <div class="testimonial-content">
    ...
    <section class="cta-section">
        <div class="container text-center">
            ...
            <div class="cta-buttons">
                <a href="./pages/register.php" class="btn btn-primary btn-lg">Crear cuenta gratis</a>
                <a href="./pages/login.php" class="btn btn-outline-light btn-lg ms-3">Iniciar sesión</a>
            </div>
        </div>
        <div class="cta-wave">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1440 320">
        ...
        <div class="container">
            ...
            <div class="row">
                <div class="col-md-12 text-center">
                    <p class="copyright">&copy; 2024 MatchFilm. Todos los derechos reservados a Hugo Casado.</p>
                </div>
            </div>
        </div>
    </footer>
